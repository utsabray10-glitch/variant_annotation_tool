...
def main():
    ...
    parser.add_argument("--vcf", type=Path, default="challenge_data.vcf", help="Path to input VCF file")
    parser.add_argument("--output", type=Path, default="annotated_variants.csv", help="Path to output CSV file with annotated variants")
    parser.add_argument("--threads", type=int, default=8, help="Number of threads for parallel processing (max 32)", choices=range(1, 33))
